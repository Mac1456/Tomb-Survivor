...
static func _static_init():
	characters = [
		Character.new(
			"Knight",
			"A skilled warrior with devastating sword techniques and protective abilities",
			9, 7, 8, 8,
			"melee",
			"Sword Spin",
			"Spins with sword extended, dealing damage to all nearby enemies",
			"Knight's Valor",
			"Increases attack speed and damage while healing over time",
		...
		Character.new(
			"Wizard",
			"A wise sorcerer wielding powerful magical abilities",
			5, 6, 4, 6,
			"ranged",
			"Magic Missile",
			"Launches homing magical projectiles that pierce enemies",
			"Arcane Storm",
			"Creates a magical storm that damages all nearby enemies",
